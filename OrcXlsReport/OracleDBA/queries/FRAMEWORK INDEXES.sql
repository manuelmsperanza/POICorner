with list_cols as (select TABLE_NAME, INDEX_NAME,  LISTAGG(column_name||' '||DESCEND,', ') WITHIN GROUP (ORDER BY COLUMN_POSITION) column_list
from user_ind_columns
group by table_name, index_name)
select ui.table_name, ui.index_name, list_cols.column_list
from user_indexes ui, list_cols
